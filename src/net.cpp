...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("sterlingcoin-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("sterlingcoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sterlingcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("sterlingcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("sterlingcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("sterlingcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("sterlingcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sterlingcoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("sterlingcoin-start");
